...
function checkForRounds(round) {
  if (round === 11) {
    ...
    h6.innerText = "You have completed all the levels!\n\nPlay Again?";

    // Create "Yes" button
    nextLevelButton.innerText = "Yes";
    ...
    // Append "No" button to the same parent as "Yes" button
    nextLevelButton.parentNode.appendChild(noButton);
